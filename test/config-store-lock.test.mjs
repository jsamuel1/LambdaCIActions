// The config store's two write-safety behaviours (ADR-033 review follow-up):
//
...
// /api/settings` is readable by ANY authenticated session (ADR-034), and concurrent reads scale
