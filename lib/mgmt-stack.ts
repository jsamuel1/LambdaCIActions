 ...
 *     ADR-028 installation index repair — both `SET`s of specific attributes on an existing
...
export class MgmtStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: MgmtStackProps) {
    ...
    // config (enabled/mode/defaultFlavor/flavorMap) and the ADR-028 installation GSI1 index
