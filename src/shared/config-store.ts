 ...
 * that GitHub can reach us (ADR-034). It is written by Ingest on every accepted delivery as
 ...
 * by ANY authenticated session (ADR-035 keeps it readable on purpose), each read invokes the
